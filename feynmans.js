...
var feynmanDiagrams = {
  ...
  Feynman781: {
    ...
    label: {
      ...
      t9: ['515,17', '+', 20, 20],
      t10: ['574,17', '+', 20, 20],
      t11: ['627,17', '+ $\\cdots$', 40, 20],
      // denominador
      t12: ['251,58', '$1$ +', 30, 20],
      t13: ['299,58', '+', 20, 20],
      t14: ['350,58', '+', 20, 20],
      t15: ['382,58', '+', 20, 20],
      t16: ['425,58', '+ $\\cdots$', 40, 20],
    },
    mathjax: mathjaxDefined,
  },
  ...
  Feynman782: {
    ...
    auxiliary: {
      a28: '118,20',
      a29: '160,20', a30: '180,20',
      a31: '222,10',
    },
    vertex: {
      v24: '118,30',
      v25: '160,30', v26: '180,30',
      v27: '222,30', v28: '222,20',
      v29: '264,30', v30: '280,30',
    },
    node: {show: 'v', type: 'dot', fill: 'red', radius: 1.2},
    fermion: {
